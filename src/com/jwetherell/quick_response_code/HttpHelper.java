...
public final class HttpHelper {
    ...
    private static final Collection<String> REDIRECTOR_DOMAINS = new HashSet<String>(Arrays.asList(
            ...
            "ow.ly", "SCN.BY", "su.pr", "t.co", "tinyurl.com", "tr.im"));
     ...
     * @throws IOException if the content can't be retrieved because of a bad URI, network problem,
     *             etc.
     */
    ...
    private static String downloadViaHttp(String uri, String contentTypes) throws IOException {
        ...
        try {
            ...
            if (connection.getResponseCode() != HttpURLConnection.HTTP_OK) { throw new IOException(
                    "Bad HTTP response: " + connection.getResponseCode()); }
    ...
    private static String getEncoding(URLConnection connection) {
        ...
        if (contentTypeHeader != null) {
            ...
            if (charsetStart >= 0) { return contentTypeHeader.substring(charsetStart
                    + "charset=".length()); }
        }
        return "UTF-8";
    }
    ...
    public static URI unredirect(URI uri) throws IOException {
        if (!REDIRECTOR_DOMAINS.contains(uri.getHost())) { return uri; }
        URL url = uri.toURL();
