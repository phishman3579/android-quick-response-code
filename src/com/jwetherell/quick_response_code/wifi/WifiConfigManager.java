...
package com.jwetherell.quick_response_code.wifi;
...
public final class WifiConfigManager {
    ...
    public static void configure(final WifiManager wifiManager, final String ssid,
            final String password, final String networkTypeString) {
    ...
    private static Integer findNetworkInExistingConfig(WifiManager wifiManager, String ssid) {
        ...
        for (WifiConfiguration existingConfig : existingConfigs) {
            if (existingConfig.SSID.equals(ssid)) { return existingConfig.networkId; }
        }
        return null;
    }
    ...
    private static boolean isHexOfLength(CharSequence value, int... allowedLengths) {
        if (value == null || !HEX_DIGITS.matcher(value).matches()) { return false; }
        if (allowedLengths.length == 0) { return true; }
