...
public interface Reader {
     ...
     *            meaning of the data depends upon the hint type. The implementation may or may not
     *            do
     *            anything with these hints.
     * @return String which the barcode encodes
     * @throws NotFoundException if the barcode cannot be located or decoded for any reason
     */
    Result decode(BinaryBitmap image, Map<DecodeHintType, ?> hints) throws NotFoundException,
