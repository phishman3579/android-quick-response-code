...
package com.jwetherell.quick_response_code.core.pdf417;
...
import com.jwetherell.quick_response_code.core.pdf417.decoder.Decoder;
import com.jwetherell.quick_response_code.core.pdf417.detector.Detector;
...
public final class PDF417Reader implements Reader {
     ...
     * case.
     * 
     * @see com.jwetherell.qrcode.core.qrcode.QRCodeReader#extractPureBits(BitMatrix)
     * @see com.jwetherell.quick_response_code.core.datamatrix.DataMatrixReader#extractPureBits(BitMatrix)
     */
    ...
    private static int moduleSize(int[] leftTopBlack, BitMatrix image) throws NotFoundException {
        ...
        if (x == width) { throw NotFoundException.getNotFoundInstance(); }
    ...
    private static int findPatternStart(int x, int y, BitMatrix image) throws NotFoundException {
        ...
        if (start == width - 1) { throw NotFoundException.getNotFoundInstance(); }
        return start;
    }
    ...
    private static int findPatternEnd(int x, int y, BitMatrix image) throws NotFoundException {
        ...
        if (end == x) { throw NotFoundException.getNotFoundInstance(); }
        return end;
    }
