...
final class DecodedBitStreamParser {
    ...
    private static void decodeTextCompaction(int[] textCompactionData, int[] byteCompactionData,
        ...
        // The default compaction mode for PDF417 in effect at the start of each symbol shall always
        // be Text
        // Compaction mode Alpha sub-mode (uppercase alphabetic). A latch codeword from another mode
        // to the Text
    ...
    private static String decodeBase900toBase10(int[] codewords, int count) throws FormatException {
        ...
        if (resultString.charAt(0) != '1') { throw FormatException.getFormatInstance(); }
