...
public final class AddressBookDoCoMoResultParser extends AbstractDoCoMoResultParser {
    ...
    public AddressBookParsedResult parse(Result result) {
        ...
        if (!rawText.startsWith("MECARD:")) { return null; }
        ...
        // Although ORG may not be strictly legal in MECARD, it does exist in VCARD and we might as
        // well
        // honor it when found in the wild.
        String org = matchSingleDoCoMoPrefixedField("ORG:", rawText, true);

        return new AddressBookParsedResult(maybeWrap(name), pronunciation, phoneNumbers, null,
                emails, null, null, note, addresses, null, org, birthday, null, url);
    }
