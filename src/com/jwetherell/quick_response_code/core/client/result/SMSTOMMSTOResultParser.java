 ...
 * 
 * <p>
 * This actually also parses URIs starting with "smsto:", "mmsto:", "SMSTO:", and "MMSTO:", and
 * treats them all the same way, and effectively converts them to an "sms:" URI for purposes of
...
public final class SMSTOMMSTOResultParser extends ResultParser {
    ...
    public SMSParsedResult parse(Result result) {
        ...
        if (!(rawText.startsWith("smsto:") || rawText.startsWith("SMSTO:")
                || rawText.startsWith("mmsto:") || rawText.startsWith("MMSTO:"))) { return null; }
