...
package com.jwetherell.quick_response_code.core.client.result;
...
/**
 * <p>
 * Abstract class representing the result of decoding a barcode, as more than a String -- as some
 * type of structured data. This might be a subclass which represents a URL, or an e-mail address.
 * {@link #parseResult(Result)} will turn a raw decoded string into the most appropriate type of
 * structured representation.
 * </p>
 * 
 * <p>
 * Thanks to Jeff Griffin for proposing rewrite of these classes that relies less on exception-based
 * mechanisms during parsing.
 * </p>
 * 
 * @author Sean Owen
 */
public abstract class ResultParser {
    ...
    private static final ResultParser[] PARSERS = {
            new BookmarkDoCoMoResultParser(), new AddressBookDoCoMoResultParser(),
            new EmailDoCoMoResultParser(), new AddressBookAUResultParser(),
            new VCardResultParser(), new BizcardResultParser(), new VEventResultParser(),
            new EmailAddressResultParser(), new SMTPResultParser(), new TelResultParser(),
            new SMSMMSResultParser(), new SMSTOMMSTOResultParser(), new GeoResultParser(),
            new WifiResultParser(), new URLTOResultParser(), new URIResultParser(),
            new ISBNResultParser(), new ProductResultParser(), new ExpandedProductResultParser(),
    };
    ...
    protected static String[] maybeWrap(String value) {
        return value == null ? null : new String[] {
            value
        };
    }
