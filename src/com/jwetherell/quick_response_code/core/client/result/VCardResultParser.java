...
public final class VCardResultParser extends ResultParser {
    ...
    public AddressBookParsedResult parse(Result result) {
        ...
        return new AddressBookParsedResult(toPrimaryValues(names), null,
                ...
                toPrimaryValue(birthday), toPrimaryValue(title), toPrimaryValue(url));
    }

    private static List<List<String>> matchVCardPrefixedField(CharSequence prefix, String rawText,
            boolean trim) {
