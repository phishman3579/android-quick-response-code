...
public final class BizcardResultParser extends AbstractDoCoMoResultParser {
    ...
    public AddressBookParsedResult parse(Result result) {
        ...
        if (!rawText.startsWith("BIZCARD:")) { return null; }
        ...
        return new AddressBookParsedResult(maybeWrap(fullName), null, buildPhoneNumbers(
                phoneNumber1, phoneNumber2, phoneNumber3), null, maybeWrap(email), null, null,
                null, addresses, null, org, null, title, null);
    }
