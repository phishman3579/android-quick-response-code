...
/**
 * <p>
 * A reader that can read all available UPC/EAN formats. If a caller wants to try to read all such
...
public final class MultiFormatUPCEANReader extends OneDReader {
    ...
    public Result decodeRow(int rowNumber, BitArray row, Map<DecodeHintType, ?> hints)
        ...
        for (UPCEANReader reader : readers) {
            ...
            if (ean13MayBeUPCA && canReturnUPCA) { return new Result(result.getText().substring(1),
                    null, result.getResultPoints(), BarcodeFormat.UPC_A); }
            return result;
        }
