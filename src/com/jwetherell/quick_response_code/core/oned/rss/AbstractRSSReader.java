...
import com.jwetherell.quick_response_code.core.oned.OneDReader;
...
public abstract class AbstractRSSReader extends OneDReader {
    ...
    protected static int parseFinderValue(int[] counters, int[][] finderPatterns)
        ...
        for (int value = 0; value < finderPatterns.length; value++) {
            if (patternMatchVariance(counters, finderPatterns[value], MAX_INDIVIDUAL_VARIANCE) < MAX_AVG_VARIANCE) { return value; }
        }
