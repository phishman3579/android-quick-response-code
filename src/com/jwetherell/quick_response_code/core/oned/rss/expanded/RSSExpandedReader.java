...
import com.jwetherell.quick_response_code.core.oned.rss.AbstractRSSReader;
...
import com.jwetherell.quick_response_code.core.oned.rss.RSSUtils;
import com.jwetherell.quick_response_code.core.oned.rss.expanded.decoders.AbstractExpandedDecoder;
...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[][] FINDER_PATTERN_SEQUENCES = {
            ...
            {
                    FINDER_PAT_A, FINDER_PAT_E, FINDER_PAT_B, FINDER_PAT_D, FINDER_PAT_D,
                    FINDER_PAT_F
            },
            {
                    FINDER_PAT_A, FINDER_PAT_E, FINDER_PAT_B, FINDER_PAT_D, FINDER_PAT_E,
                    FINDER_PAT_F, FINDER_PAT_F
            },
            {
                    FINDER_PAT_A, FINDER_PAT_A, FINDER_PAT_B, FINDER_PAT_B, FINDER_PAT_C,
                    FINDER_PAT_C, FINDER_PAT_D, FINDER_PAT_D
            },
            {
                    FINDER_PAT_A, FINDER_PAT_A, FINDER_PAT_B, FINDER_PAT_B, FINDER_PAT_C,
                    FINDER_PAT_C, FINDER_PAT_D, FINDER_PAT_E, FINDER_PAT_E
            },
            {
                    FINDER_PAT_A, FINDER_PAT_A, FINDER_PAT_B, FINDER_PAT_B, FINDER_PAT_C,
                    FINDER_PAT_C, FINDER_PAT_D, FINDER_PAT_E, FINDER_PAT_F, FINDER_PAT_F
            },
            {
                    FINDER_PAT_A, FINDER_PAT_A, FINDER_PAT_B, FINDER_PAT_B, FINDER_PAT_C,
                    FINDER_PAT_D, FINDER_PAT_D, FINDER_PAT_E, FINDER_PAT_E, FINDER_PAT_F,
                    FINDER_PAT_F
            },
    };
    ...
    List<ExpandedPair> decodeRow2pairs(int rowNumber, BitArray row) throws NotFoundException {
        while (true) {
            ...
            if (nextPair.mayBeLast()) {
                if (checkChecksum()) { return this.pairs; }
    ...
    private boolean checkPairSequence(List<ExpandedPair> previousPairs, FinderPattern pattern)
        ...
        if (currentSequenceLength > this.currentSequence.length) { throw NotFoundException
                .getNotFoundInstance(); }
    ...
    private FinderPattern parseFoundFinderPattern(BitArray row, int rowNumber, boolean oddPattern) {
        ...
        if (oddPattern) {
            ...
            // If pattern number is even, the pattern is reversed, so we need to locate element 1
        ...
        return new FinderPattern(value, new int[] {
                start, end
        }, start, end, rowNumber);
    }
    ...
    DataCharacter decodeDataCharacter(BitArray row, FinderPattern pattern, boolean isOddPattern,
        ...
        int weightRowNumber = 4 * pattern.getValue() + (isOddPattern ? 0 : 2) + (leftChar ? 0 : 1)
                - 1;
        ...
        if ((oddSum & 0x01) != 0 || oddSum > 13 || oddSum < 4) { throw NotFoundException
                .getNotFoundInstance(); }
