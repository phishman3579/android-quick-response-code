...
package com.jwetherell.quick_response_code.core.maxicode;
...
import com.jwetherell.quick_response_code.core.maxicode.decoder.Decoder;
...
public final class MaxiCodeReader implements Reader {
     ...
     * case.
     * 
     * @see com.jwetherell.quick_response_code.core.pdf417.PDF417Reader#extractPureBits(BitMatrix)
    ...
    private static BitMatrix extractPureBits(BitMatrix image) throws NotFoundException {
        ...
        if (enclosingRectangle == null) { throw NotFoundException.getNotFoundInstance(); }
