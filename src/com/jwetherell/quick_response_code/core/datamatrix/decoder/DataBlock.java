...
/**
 * <p>
 * Encapsulates a block of data within a Data Matrix Code. Data Matrix Codes may split their data
 * into multiple blocks, each of which is a unit of data and error-correction codewords. Each is
...
final class DataBlock {
    ...
    /**
     * <p>
     * When Data Matrix Codes use multiple data blocks, they actually interleave the bytes of each
     * of them. That is, the first byte of data block 1 to n is written, then the second bytes, and
     * so on. This method will separate the data into original blocks.
     * </p>
     * 
