...
public final class Version {
    ...
    private Version(int versionNumber, int symbolSizeRows, int symbolSizeColumns,
            int dataRegionSizeRows, int dataRegionSizeColumns, ECBlocks ecBlocks) {
    ...
    public static Version getVersionForDimensions(int numRows, int numColumns)
        ...
        if ((numRows & 0x01) != 0 || (numColumns & 0x01) != 0) { throw FormatException
                .getFormatInstance(); }
     ...
     * is used consecutively in the Data Matrix code version's format.
     * </p>
     */
