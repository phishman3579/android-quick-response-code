...
/**
 * <p>
 * Data Matrix Codes can encode text as bits in one of several modes, and can use multiple modes in
 * one Data Matrix Code. This class decodes the bits back into text.
 * </p>
 * 
 * <p>
...
final class DecodedBitStreamParser {
     ...
     */
    private static Mode decodeAsciiSegment(BitSource bits, StringBuilder result,
        ...
        do {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (edifactValue == 0x1F) { // 011111
                    unlatch = true;
                    // If we encounter the unlatch code then continue reading because the Codeword
                    // triple
                    // is padded with 0's
                }
    ...
    private static void decodeBase256Segment(BitSource bits, StringBuilder result,
        ...
        if (count < 0) { throw FormatException.getFormatInstance(); }

        byte[] bytes = new byte[count];
        for (int i = 0; i < count; i++) {
            // Have seen this particular error in the wild, such as at
            // http://www.bcgen.com/demo/IDAutomationStreamingDataMatrix.aspx?MODE=3&D=Fred&PFMT=3&PT=F&X=0.3&O=0&LM=0.2
            if (bits.available() < 8) { throw FormatException.getFormatInstance(); }
