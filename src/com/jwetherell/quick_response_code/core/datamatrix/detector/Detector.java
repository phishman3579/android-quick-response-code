...
package com.jwetherell.quick_response_code.core.datamatrix.detector;
...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        // Figure out which point is their intersection by tallying up the number of times we see
        // the
        ...
        for (Map.Entry<ResultPoint, Integer> entry : pointCount.entrySet()) {
            ...
            if (value == 2) {
                bottomLeft = point; // this is definitely the bottom left, then -- end of two L
                                    // sides
            } else {
                // Otherwise it's either top left or bottom right -- just assign the two arbitrarily
                // now
        ...
        if (maybeTopLeft == null || bottomLeft == null || maybeBottomRight == null) { throw NotFoundException
                .getNotFoundInstance(); }
        ...
        // Next determine the dimension by tracing along the top or right side and counting
        // black/white
        // transitions. Since we start inside a black module, we should see a number of transitions
        // equal to 1 less than the code dimension. Well, actually 2 less, because we are going to
        // end on a black module:

        // The top right point is actually the corner of a module, which is one of the two black
        // modules
        ...
        // Rectanguar symbols are 6x16, 6x28, 10x24, 10x32, 14x32, or 14x44. If one dimension is
        // more
        // than twice the other, it's certainly rectangular, but to cut a bit more slack we accept
        // it as
    ...
    private ResultPoint correctTopRightRectangular(ResultPoint bottomLeft, ResultPoint bottomRight,
        ...
        if (!isValid(c1)) {
            if (isValid(c2)) { return c2; }
            return null;
        }
        if (!isValid(c2)) { return c1; }
