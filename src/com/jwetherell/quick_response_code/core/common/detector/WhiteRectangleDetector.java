...
/**
 * <p>
 * Detects a candidate barcode-like rectangular region within an image. It starts around the center
 * of the image, increases the size of the candidate region until it finds a white rectangular
 * region. By keeping track of the last black points it encountered, it determines the corners of
 * the barcode.
 * </p>
 * 
...
public final class WhiteRectangleDetector {
    ...
    public WhiteRectangleDetector(BitMatrix image) throws NotFoundException {
        ...
        if (upInit < 0 || leftInit < 0 || downInit >= height || rightInit >= width) { throw NotFoundException
                .getNotFoundInstance(); }
    }
    ...
    /**
     * <p>
     * Detects a candidate barcode-like rectangular region within an image. It starts around the
     * center of the image, increases the size of the candidate region until it finds a white
     * rectangular region.
     * </p>
     * 
    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        if (!sizeExceeded && atLeastOneBlackPointFoundOnBorder) {
            ...
            if (z == null) { throw NotFoundException.getNotFoundInstance(); }
            ...
            if (t == null) { throw NotFoundException.getNotFoundInstance(); }
            ...
            if (x == null) { throw NotFoundException.getNotFoundInstance(); }
            ...
            if (y == null) { throw NotFoundException.getNotFoundInstance(); }
