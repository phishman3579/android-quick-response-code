...
public final class PreferencesActivity extends PreferenceActivity implements
    ...
    protected void onCreate(Bundle icicle) {
        ...
        decode1D = (CheckBoxPreference) preferences.findPreference(Preferences.KEY_DECODE_1D);
        decodeQR = (CheckBoxPreference) preferences.findPreference(Preferences.KEY_DECODE_QR);
        decodeDataMatrix = (CheckBoxPreference) preferences
                .findPreference(Preferences.KEY_DECODE_DATA_MATRIX);
