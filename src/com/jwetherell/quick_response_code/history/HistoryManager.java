...
public final class HistoryManager {
    ...
    private static final String[] COLUMNS = {
            DBHelper.TEXT_COL, DBHelper.DISPLAY_COL, DBHelper.FORMAT_COL, DBHelper.TIMESTAMP_COL,
    ...
    public AlertDialog buildAlert() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                Result result = new Result(text, null, null, BarcodeFormat.valueOf(format),
                        timestamp);
                items.add(result);
    ...
    public void addHistoryItem(Result result, ResultHandler handler) {
        ...
        if (!activity.getIntent().getBooleanExtra(Intents.Scan.SAVE_HISTORY, true)
                || handler.areContentsSecure()) { return; }
    ...
    public void addHistoryItemDetails(String itemID, String itemDetails) {
        ...
        try {
            ...
            try {
                cursor = db.query(DBHelper.TABLE_NAME, ID_DETAIL_COL_PROJECTION, DBHelper.TEXT_COL
                        + "=?", new String[] {
                    itemID
            ...
            db.update(DBHelper.TABLE_NAME, values, DBHelper.ID_COL + "=?", new String[] {
                oldID
            });
    ...
    private void deletePrevious(String text) {
        ...
        try {
            db.delete(DBHelper.TABLE_NAME, DBHelper.TEXT_COL + "=?", new String[] {
                text
            });
        } finally {
            db.close();
    ...
    CharSequence buildHistory() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                historyText.append('"').append(massageHistoryField(cursor.getString(0)))
                        .append("\",");
                historyText.append('"').append(massageHistoryField(cursor.getString(1)))
                        .append("\",");
                historyText.append('"').append(massageHistoryField(cursor.getString(2)))
                        .append("\",");
                historyText.append('"').append(massageHistoryField(cursor.getString(3)))
                        .append("\",");
                ...
                historyText
                        .append('"')
                        .append(massageHistoryField(EXPORT_DATE_TIME_FORMAT.format(new Date(
                                timestamp)))).append("\",");

                // Above we're preserving the old ordering of columns which had formatted data in
                // position 5

                historyText.append('"').append(massageHistoryField(cursor.getString(4)))
                        .append("\"\r\n");
            }
