...
package com.jwetherell.quick_response_code.book;
...
final class NetworkWorker implements Runnable {
    ...
    public void run() {
        try {
            // These return a JSON result which describes if and where the query was found. This API
            // may
            ...
            if (LocaleManager.isBookSearchUrl(isbn)) {
                ...
                uri = "http://www.google.com/books?id=" + volumeId
                        + "&jscmd=SearchWithinVolume2&q=" + query;
            } else {
                uri = "http://www.google.com/books?vid=isbn" + isbn
                        + "&jscmd=SearchWithinVolume2&q=" + query;
            }
